class Dclaude < Formula
  ...
  url "https://github.com/stanislavkozlovski/dclaude/releases/download/v0.1.64/dclaude-v0.1.64.tar.gz"
  sha256 "588647629cc3883db4df423dd77454470202c56438eab917b3b891c82346c29f"
